...
public class EnvironmentDialog extends TitleAreaDialog {
	...
	private void saveInput() {
		...
		prefs.put("images", String.format("%s/%s:%s", environment.substring(0, 4),environment.substring(4,environment.length()-4),environment.substring(environment.length()-4)));
